package com.orataro.customeview;
...
public class PanAndZoomListener implements OnTouchListener {
	...
	public PanAndZoomListener(View containter, View view, int anchor) {
	...
	class PanZoomCalculator {
		...
		@SuppressLint("NewApi") PanZoomCalculator(View container, View child, int anchor) {
